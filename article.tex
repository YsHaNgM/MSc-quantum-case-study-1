...
``Nature isn't classical, dammit, and if you want to make a simulation of nature, you'd better make it quantum mechanical, and by golly it's a wonderful
 ...
 since then. The paper `Scalable Quantum Simulation of Molecular Energies' \cite{o2016scalable} by O’Malley et al. is evidence of just how far the technology
...
both a predetermined `0’ and a `1’ state. In paper \cite{o2016scalable} by O’Malley et al., the quantum algorithms were run on superconducting qubits. These are a
...
As it is known, building a quantum computer comes with many challenges, one being the aspect of scalability. As the number of qubits increases, it becomes increasingly difficult to solve chemical rates. Senior research fellow Dr Lluis Masanes at University College London commented “Many quantum simulators such as the ion trap give good results but they are not scalable”. Adding more degrees of freedom, becomes computationally challenging and thus impossible to solve classically. 

One of the advantages of using PEA to
...
and Outlook sections and the Experimental Implementation section and box. Shanice St John wrote the Techniques in Paper section introduction and the Main Achievement of Paper section, and the VQE section and box. However we all edited and redrafted together and interviewed the academics
whose opinions we quoted in the article. We would like to thank Dr Abolfazl Bayat, Prof. Dan Browne, Mikolaj Uryszek and Dr Lluis Masanes for kindly talking to
