...
\]
\end{footnotesize}
As we can see, the result of QFT is just the first part of qubits we prepared. Therefore we would apply the reverse QFT onto those qubits, and outputs a single state contains all information about phase we want!
\end{minipage}}
